...
from creadto.services.reconstruction import reconstruct_human_from_directory, reconstruct_human_from_file
...
result = reconstruct_human_from_file("./sample/m-daniel-half.jpeg")
visualize_meshes(**result)

result = reconstruct_human_from_directory("./sample")
visualize_meshes(**result)
